...
class AcpBridgeClient : public QObject
{
  ...
  public:
    ...
    QJsonObject listSkills(QString *errorMessage, int timeoutMs = 3000);
    QJsonObject applySkillAction(const QJsonObject &payload, QString *errorMessage, int timeoutMs = 5000);
